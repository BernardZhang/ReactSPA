...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! /Users/baidu/Desktop/Demo/ReactSPA/app/app.jsx */159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./css/style.less */ 160);
	...
	var _Header = __webpack_require__(/*! ./components/Header.jsx */ 214);
	...
	var App = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_Header2.default, { selectedItem: this.props.location.pathname }),
	...
	var routes = {
		...
		indexRoute: {
			getComponent: function getComponent(location, cb) {
				...
				return __webpack_require__.e/* nsure */(2, function (require) {
					debugger;
					alert(JSON.stringify(__webpack_require__(/*! ./views/About.jsx */ 1)));
		...
		childRoutes: [{
			path: '/',
			getComponent: function getComponent(location, cb) {
				return __webpack_require__.e/* nsure */(2/* duplicate */, function (require) {
					cb(null, __webpack_require__(/*! ./views/About */ 1));
				});
			}
		}, {
			...
			getComponent: function getComponent(location, cb) {
				return __webpack_require__.e/* nsure */(3, function (require) {
					cb(null, __webpack_require__(/*! ./views/Inbox */ 217));
				});
			},
			onEnter: onEnter,
			onLeave: onLeave
			...
			getComponent: function getComponent(location, cb) {
				return __webpack_require__.e/* nsure */(4, function (require) {
					cb(null, __webpack_require__(/*! ./views/Message */ 220));
				});
			},
			onEnter: onEnter,
			onLeave: onLeave
	...
	_reactDom2.default.render(_react2.default.createElement(_reactRouter.Router, { history: _reactRouter.browserHistory, routes: routes }), document.querySelector('#app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./../../~/less-loader!./style.less */ 161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../css/header.less */ 215);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./../../~/less-loader!./header.less */ 216);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../~/style-loader/addStyles.js */ 163)(content, {});
	if(content.locals) module.exports = content.locals;
...
/***/ 216:
/*!************************************************************!*\
  !*** ./~/css-loader!./~/less-loader!./app/css/header.less ***!
  \************************************************************/
/***/ function(module, exports, __webpack_require__) {
